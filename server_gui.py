...
# Назначаем класс основного окна, наследуемся от PyQt5.QtWidgets.QMainWindow
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        #добавляес виджет Тулбар
        self.toolbar = self.addToolBar('MainBar')
        
        # добавляем 4 кнопки на тул бар
        ...
        # Ниже Добавляем виджет Надпись(Label) с текстом
        self.label = QLabel('Список подключённых клиентов:', self)
        # задаем параметры(размер, положение)
        self.label.setFixedSize(240, 15)
        self.label.move(25, 30)

        # # Ниже  добавляем Окно со списком подключённых клиентов.
